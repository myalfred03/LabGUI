...
Pane {
    ...
    TabBar {
        ...
        TabButton {
            text: qsTr("Articulo 1")
            onClicked: {
                showSubMenu("qrc:/qml/Main/Biblio/Content/Art1.qml")
                       }
                  }

        TabButton {
            text: qsTr("Articulo 2")
            onClicked: {
                showSubMenu("qrc:/qml/Main/Biblio/Content/Art2.qml")
                       }
                  }
